...
BEGIN
  ...
  IF next_version = 23 THEN
    ...
    EXECUTE 'CREATe TABLE "datum"("id" SERIAL8  PRIMARY KEY UNIQUE,"hash" hash32type NOT NULL,"tx_id" INT8 NOT NULL,"value" jsonb NULL, "no_schema_value" jsonb NULL, "raw_value" bytea NULL)' ;
