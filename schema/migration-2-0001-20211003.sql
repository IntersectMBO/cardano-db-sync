...
BEGIN
  ...
  IF next_version = 1 THEN
    ...
    EXECUTE 'CREATe TABLE "tx"("id" SERIAL8  PRIMARY KEY UNIQUE,"hash" hash32type NOT NULL,"block_id" INT8 NOT NULL,"block_index" uinteger NOT NULL,"out_sum" lovelace NOT NULL,"fee" lovelace NOT NULL,"deposit" INT8 NOT NULL,"size" uinteger NOT NULL,"invalid_before" word64type NULL,"invalid_hereafter" word64type NULL,"valid_contract" BOOLEAN NOT NULL,"script_size" uinteger NOT NULL)' ;
    ...
    EXECUTE 'CREATe TABLE "redeemer"("id" SERIAL8  PRIMARY KEY UNIQUE,"tx_id" INT8 NOT NULL,"unit_mem" word63type NOT NULL,"unit_steps" word63type NOT NULL,"fee" lovelace NOT NULL,"purpose" scriptpurposetype NOT NULL,"index" uinteger NOT NULL,"script_hash" hash28type NULL,"datum_id" INT8 NOT NULL)' ;
    ...
    EXECUTE 'CREATe TABLE "stake_registration"("id" SERIAL8  PRIMARY KEY UNIQUE,"addr_id" INT8 NOT NULL,"cert_index" INT4 NOT NULL,"epoch_no" uinteger NOT NULL,"tx_id" INT8 NOT NULL)' ;
    ...
    EXECUTE 'CREATe TABLE "stake_deregistration"("id" SERIAL8  PRIMARY KEY UNIQUE,"addr_id" INT8 NOT NULL,"cert_index" INT4 NOT NULL,"epoch_no" uinteger NOT NULL,"tx_id" INT8 NOT NULL,"redeemer_id" INT8 NULL)' ;
    ...
    EXECUTE 'CREATe TABLE "delegation"("id" SERIAL8  PRIMARY KEY UNIQUE,"addr_id" INT8 NOT NULL,"cert_index" INT4 NOT NULL,"pool_hash_id" INT8 NOT NULL,"active_epoch_no" INT8 NOT NULL,"tx_id" INT8 NOT NULL,"slot_no" uinteger NOT NULL,"redeemer_id" INT8 NULL)' ;
    ...
    EXECUTE 'CREATe TABLE "epoch_stake"("id" SERIAL8  PRIMARY KEY UNIQUE,"addr_id" INT8 NOT NULL,"pool_id" INT8 NOT NULL,"amount" lovelace NOT NULL,"epoch_no" uinteger NOT NULL)' ;
    ...
    EXECUTE 'CREATe TABLE "script"("id" SERIAL8  PRIMARY KEY UNIQUE,"tx_id" INT8 NOT NULL,"hash" hash28type NOT NULL,"type" scripttype NOT NULL,"json" jsonb NULL,"bytes" bytea NULL,"serialised_size" uinteger NULL)' ;
    ...
    EXECUTE 'CREATe TABLE "param_proposal"("id" SERIAL8  PRIMARY KEY UNIQUE,"epoch_no" uinteger NOT NULL,"key" hash28type NOT NULL,"min_fee_a" word64type NULL,"min_fee_b" word64type NULL,"max_block_size" word64type NULL,"max_tx_size" word64type NULL,"max_bh_size" word64type NULL,"key_deposit" lovelace NULL,"pool_deposit" lovelace NULL,"max_epoch" word64type NULL,"optimal_pool_count" word64type NULL,"influence" DOUBLE PRECISION NULL,"monetary_expand_rate" DOUBLE PRECISION NULL,"treasury_growth_rate" DOUBLE PRECISION NULL,"decentralisation" DOUBLE PRECISION NULL,"entropy" hash32type NULL,"protocol_major" uinteger NULL,"protocol_minor" uinteger NULL,"min_utxo_value" lovelace NULL,"min_pool_cost" lovelace NULL,"coins_per_utxo_word" lovelace NULL,"cost_model_id" INT8 NULL,"price_mem" DOUBLE PRECISION NULL,"price_step" DOUBLE PRECISION NULL,"max_tx_ex_mem" word64type NULL,"max_tx_ex_steps" word64type NULL,"max_block_ex_mem" word64type NULL,"max_block_ex_steps" word64type NULL,"max_val_size" word64type NULL,"collateral_percent" uinteger NULL,"max_collateral_inputs" uinteger NULL,"registered_tx_id" INT8 NOT NULL)' ;
