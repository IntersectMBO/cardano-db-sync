...
BEGIN
  ...
  IF next_version = 4 THEN
    ...
    EXECUTE 'ALTER TABLE "param_proposal" ADD COLUMN "ada_per_u_tx_o_word" lovelace NULL' ;
    EXECUTE 'ALTER TABLE "param_proposal" ADD COLUMN "cost_models" VARCHAR NULL' ;
    EXECUTE 'ALTER TABLE "param_proposal" ADD COLUMN "price_mem" lovelace NULL' ;
    EXECUTE 'ALTER TABLE "param_proposal" ADD COLUMN "price_step" lovelace NULL' ;
