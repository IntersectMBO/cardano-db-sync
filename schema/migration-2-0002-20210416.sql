...
BEGIN
  ...
  IF next_version = 2 THEN
    EXECUTE 'CREATe TABLE "pool_metadata_reference"("id" SERIAL8  PRIMARY KEY UNIQUE,"pool_id" text NOT NULL,"url" text NOT NULL,"hash" text NOT NULL)' ;
    EXECUTE 'ALTER TABLE "pool_metadata_reference" ADD CONSTRAINT "unique_pool_metadata_reference" UNIQUE("pool_id","hash")' ;
    ...
    EXECUTE 'ALTER TABLE "pool_metadata" ADD CONSTRAINT "pool_metadata_pmr_id_fkey" FOREIGN KEY("pmr_id") REFERENCES "pool_metadata_reference"("id") ON DELETE RESTRICT  ON UPDATE RESTRICT' ;
    ...
    EXECUTE 'ALTER TABLE "pool_metadata_fetch_error" ADD CONSTRAINT "pool_metadata_fetch_error_pmr_id_fkey" FOREIGN KEY("pmr_id") REFERENCES "pool_metadata_reference"("id") ON DELETE RESTRICT  ON UPDATE RESTRICT' ;
