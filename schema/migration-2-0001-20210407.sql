...
BEGIN
  ...
  IF next_version = 1 THEN
    ...
    EXECUTE 'CREATe TABLE "block"("id" SERIAL8  PRIMARY KEY UNIQUE,"hash" hash32type NOT NULL,"epoch_no" uinteger NULL,"slot_no" uinteger NULL,"epoch_slot_no" uinteger NULL,"block_no" uinteger NULL,"previous_id" INT8 NULL,"merkle_root" hash32type NULL,"slot_leader_id" INT8 NOT NULL,"size" uinteger NOT NULL,"time" timestamp NOT NULL,"tx_count" INT8 NOT NULL,"proto_major" uinteger NOT NULL,"proto_minor" uinteger NOT NULL,"vrf_key" VARCHAR NULL,"op_cert" hash32type NULL)' ;
