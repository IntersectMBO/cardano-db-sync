...
queryStakeAddressTransactions :: MonadIO m => TxOutVariantType -> Text -> ReaderT SqlBackend m [Transaction]
...
queryOutputs :: MonadIO m => TxOutVariantType -> StakeAddressId -> ReaderT SqlBackend m [Transaction]
