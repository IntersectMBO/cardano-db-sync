...
insertAddressDetail :: (MonadBaseControl IO m, MonadIO m) => AddressDetail -> ReaderT SqlBackend m AddressDetailId
insertAddressDetail = insertUnchecked "insertAddressDetail"
