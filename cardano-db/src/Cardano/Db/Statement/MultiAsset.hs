...
insertBulkMaTxMint :: [SMA.MaTxMint] -> DbM [Id.MaTxMintId]
insertBulkMaTxMint maTxMints =
  runSession $ HsqlSes.statement maTxMints insertBulkMaTxMintStmt

-- | Pool version for parallel operations
parallelInsertBulkMaTxMint :: [SMA.MaTxMint] -> DbM [Id.MaTxMintId]
