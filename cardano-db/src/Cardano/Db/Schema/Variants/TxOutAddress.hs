...
-- TxOut
-----------------------------------------------------------------------------------------------
data TxOutVariant = TxOutVariant
  { txOutVariantId :: !TxOutId
  , txOutVariantTxId :: !TxId
  , txOutVariantIndex :: !Word64
  , txOutVariantStakeAddressId :: !(Maybe StakeAddressId)
  , txOutVariantValue :: !DbLovelace
  , txOutVariantDataHash :: !(Maybe ByteString)
  , txOutVariantInlineDatumId :: !(Maybe DatumId)
  , txOutVariantReferenceScriptId :: !(Maybe ScriptId)
  , txOutVariantConsumedByTxId :: !(Maybe TxId)
  , txOutVariantAddressId :: !AddressId
  }
  deriving (Eq, Show, Generic)

newtype TxOutVariantId = TxOutVatiantId { unTxOutVariantId :: Word64 }
...
--     txOutVariantId             TxOutId             noreference
--     deriving Show
-- |]
